...
@app.on_message(command("addstream") & user(SUDOERS) & ~BANNED_USERS)
...
@app.on_message(command("delstream") & user(SUDOERS) & ~BANNED_USERS)
...
@app.on_message(command("liststream") & user(SUDOERS) & ~BANNED_USERS)
